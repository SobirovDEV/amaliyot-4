window.addEventListener("DOMContentLoaded", () => {
  ...
  const modalTimer = setTimeout(openModel, 5000);
  ...
  class CarCard {
    constructor(src, alt, title, deascr, price, parentSelector, ...classess) {
      this.src = src;
      this.alt = alt;
      this.title = title;
      this.deascr = deascr;
    ...
    render() {
      ...
      <img src=${this.src} alt=${this.alt} />
        ...
        <div class="menu__item-descr">${this.deascr}</div>
  ...
  //   }
  //   sildes.forEach((item) => (item.style.cssText = "display:none"));
  ...
  const slides = document.querySelectorAll(".offer__slide"),
    ...
    current = document.querySelector("#current"),
    total = document.querySelector("#total"),
    sldesWrapper = document.querySelector(".offer__slider-wrapper"),
    width = window.getComputedStyle(sldesWrapper).width,
  ...
  sldesWrapper.style.overflow = "hidden";
